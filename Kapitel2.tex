...
\subsubsection{Geschwindigkeits- und Positionsmessung}
...
$\begin{minipage}[b]{7cm}
\centering
\includegraphics[scale=0.3]{Bilder/PerspektiveCar.png} 
...
\begin{minipage}[b]{7cm}
\centering
\includegraphics[scale=0.4]{Bilder/NonPerspektiveCar.png} 
