...
In diesem Bericht werden Werkzeuge und Verfahren aufgezeigt, um ein autonomes Modellfahrzeug im Maßstab 1:10 einer Fahrspur folgen und eine vorgebbare Distanz fahren zu lassen. Diese Arbeit wurde unter der Berücksichtigung der Teilnahme an dem internationalen studentischen Wettbewerbs Carolo-Cup \cite{RegelW}, ausgetragen von der Technischen Universität Braunschweig, entworfen. Das Teamprojekt von Studenten verschiedener Fachrichtungen der OvGU, welches am Carolo-Cup teilnimmt, fährt unter dem Namen oTToCAR. Die Betreuung und Zusamenarbeit erfolgt dabei durch die Fakultäten für Informatik, für Elektrotechnik und Informationstechnik und für Maschinenbau. Die Vorbereitung dieser Arbeit ist maßgeblich an das Forschungsprojekt \cite{VikAnd} von Viktoria Wiedmeyer und Andreas Himmel geknüpft, auf das sich das im folgenden verwendete Modell der Fahrzeugdynamik hauptsächlich bezieht. 